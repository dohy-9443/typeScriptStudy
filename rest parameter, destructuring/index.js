...
// 배열도 당연히 가능
// 함수도 가능
function DestFunction({ student, age }) {
...
*/
function DestQ2({ user, comment, admin }) {
...
*/
function DestQ3([arrNum, arrStr, arrBool]) {
